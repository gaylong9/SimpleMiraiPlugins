...
public final class SayHiInGroupplugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // 引入插件数据
        MyPluginData pluginData = MyPluginData.INSTANCE;
        ...
        // 注册命令
        CommandManager.INSTANCE.registerCommand(PluginCommand.INSTANCE, false);
    ...
    public void onDisable() {
        savePluginData(MyPluginData.INSTANCE);
        super.onDisable();
    }

    private void loadPluginData(MyPluginData pluginData) {
        Yaml yaml = new Yaml();
    ...
    private void savePluginData(MyPluginData pluginData) {
        Yaml yaml = new Yaml();
        String mclPath = System.getProperty("user.dir");
